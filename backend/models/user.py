...
class User(db.Model):
    ...
    email = db.Column(db.Integer, nullable=False, default=False)
    ...
    def __repr__(self):
        ...
        {self.club}, {self.street}, {self.zip_code}, {self.city}, {self.region}, {self.preferred_contact}>"


class UserSchema(ma.Schema):
    class Meta:
        fields = ("id", "first_name", "last_name", "email", "phone", "club", 
                  "street", "zip_code", "city", "region", "preferred_contact")
